...
<html lang="es">
    ...
    <body>
        ...
        <form name="formCheques" id="formCheques" method="post" enctype="multipart/form-data">
            <div id="main_container">    
                <?php include('OpeFin00_MenuPrincipal.php'); // Incluye el menú principal?>
                <section class="datos-personales2">
                    <h2 class="titleM">Cheques</h2>
                                ...
                                <section class="seccion_caja_despliegue" id="secCta">
                                    <div class="caja_captura">
                                        <label class="lbl_txt">Cuenta</label>
                                         ...
                                         onchange="despliegaSaldoHoy(this.value,true);" ></select>
                                    </div>
                                     <div class="caja_captura">
                                ...
                                <section class="seccion_caja_despliegue" id="despliegue">
                                    ...
                                    <div class="caja_captura">
                                        <label class="lbl_txt" for="idCtrl">Control</label>
                                         <select name="idCtrl" id="idCtrl"></select>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="caja_captura">
                                        <label class="lbl_txt">Importe</label>
                                         <input type="text"  id="idImpo" onblur="soloImportes('Importe',this.id)" />
                                    </div>
                                    <div class="caja_captura">
                                        <label class="lbl_txt">Documento(Osp,Contrato)</label>
                                         <input type="text"  id="idRecibo"  /> <!-- No cambiar nombre de id -->
                                    </div>
                                    <div class="caja_captura">
                                        <label class="lbl_txt">Número de Cheque</label>
                                         <input type="text"  id="idRefe" onfocus="guardarValorOriginal(this)"; onblur="soloNumeros(this.value,'Cheque',this.id);validaReferencia(this.value);"/>
                                         <!--  onkeydown="detectarShiftTab(event,this.value);"    -->
                                    </div>
                                    <div class="caja_captura">
                                        <label class="lbl_txt">Año Ejercicio</label>
                                         <input type="text"  id="idAnio" onblur="soloNumeros(this.value,'Año Ejercicio',this.id);validaAnio(this.value,this.id);" />
                                    </div>
                                    <div class="caja_captura">
                                        <label class="lbl_txt">id</label>
                                         <input type="text" readonly disabled id="idMovimiento"/>
                                    </div>
                                    <div class="caja_captura">
                                        <label class="lbl_txt">Estatus</label>
...
<!--                            ____________________________________________________________________                -->
                                <section class="seccion_caja" id="botones">
                                    <div class="caja_captura disabled" id="divLayOut1">
                                        ...
                                        <select id="selectLayOut" onchange="archivoLayOut(this.value,'Che');">
                                    ...
                                    <div class="form-field-button_" id="grpBotones">
                                        ...
                                        <a class="btn_1 efecto" onclick="DialogoImprimirCheque();" >
                                            <span>Imprimir</span>
                                        </a>
                                    </div>
                                </section>
                                ...
                                <section class="seccion_caja" id="busqueda">
                                    ...
                                    <div class="caja_captura" id="filtroBusqueda">
                                        ...
                                        <select name="opcionesFiltro" id="opcionesFiltro" class="form-select" onchange="CambiaLetrero();">
                                            ...
                                            <option value="O">Cheque</option>
                                            <option value="R">Documento</option>
                                        </select>
                                    </div>
...
<!--        Fin Cancela LayOut ____________________________________________________            -->
            <dialog id="cajaImprimeCheque" class="dialogo">
                <div class="dialogo_header">
                    <div id="dialogo_close4" class="claseX">&#8999;</div>
                </div>
                <hr>
                <div class="dialogo_body">
                    <div class="caja_captura">
                        <label for="idNumChe" class="lbl_txt">Cheque : </label>
                        <input type="text" id="idNumChe" onfocus="this.select();">
                    </div>
                </div>
                <div class="dialogo_botones">
                    <button id="btnImprime" class="detalle_button1" onclick="validaCheImp(true)">Imprimir</button>
                </div>
            </dialog>
<!--        Cancela por LayOut _____________________________________________________            -->
        </form>
