...
<html lang="es">
    ...
    <body>
        ...
        <form name="formEgreso" id="formEgreso" method="post" enctype="multipart/form-data">
            <div id="main_container">    
                <?php include('OpeFin00_MenuPrincipal.php'); // Incluye el menú principal?>
                <section class="datos-personales2">
                    <h2 class="titleM">Egresos</h2>
                                ...
                                <section class="seccion_caja_despliegue" id="despliegue">
                                    ...
                                    <div class="caja_captura">
                                        <label class="lbl_txt">Documento(Osp,Contrato)</label>
                                         <input type="text"  id="idRecibo" onblur="soloLetrasNumerosGuion(this.value,'Documento',this.id)" /> <!-- No cambiar nombre de id -->
                                    </div>
                                    <div class="caja_captura">
                                        <label class="lbl_txt">Referencia Bancaria</label>
                                         <input type="text"  id="idRefe" onfocus="guardarValorOriginal(this)"; onblur="validaReferencia(this.value);"/>
...
<!--                            ____________________________________________________________________                -->
                                <section class="seccion_caja" id="botones">
                                    <div class="caja_captura disabled" id="divLayOut1">
                                        ...
                                        <select id="selectLayOut" onchange="archivoLayOut(this.value,'Egr');">
